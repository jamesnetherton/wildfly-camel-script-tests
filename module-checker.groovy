...
def paths = [System.getProperty("wildfly.module.dir"), System.getProperty("smartics.module.dir")]
def ignoredDependencies = System.getProperty("ignoredDependencies") != null ? new XmlParser().parseText(System.getProperty("ignoredDependencies")) : []
def modules = []
...
if (problems.size() > 0) {
    ...
    println ""
    System.exit(1)("Module dependency conflicts were detected. Please fix your module dependencies.")
}
